...
for user in dataUser['25753']:
    ...
    #        " | workedHours = " + str(workedHours) +
    #        " | workedTimeWeek = " + str(workedTimeWeek) +
    #        " | workedTimeWeekEnd = " + str(workedTimeWeekEnd) +
    #        " | workedOvertimeWeek = " + str(workedOvertimeWeek) +
    #        " | workedOvertimeWeekEnd = " + str(workedOvertimeWeekEnd)
    #      )
